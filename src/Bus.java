public class Bus extends Vehicle implements Combustion, Service<Bus>{
    private int seats;
    ...
    @Override
    public void service(Bus vehicle) {
        System.out.println("Обслуживание автобуса: " + vehicle.getBrand() + " " + vehicle.getModel());
    }
}
